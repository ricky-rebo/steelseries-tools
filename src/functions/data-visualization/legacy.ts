...
export function drawTitleImage(
  ...
  if (radial) {
    console.warn(
      "[DEPRECATED] OLD__drawTitleImage() function is deprecated! Use drawStrings() instead, for radial gauges"
    );

    drawStrings(ctx, { width, height, title, unit, labelColor: backgroundColor.labelColor });
  } else {
    console.warn(
      "[DEPRECATED] OLD__drawTitleImage() function is deprecated! Use drawLinearStrings() instead, for linear gauges"
    );

    drawLinearStrings(ctx, {
      width,
      height,
      title,
      unit,
...
export function drawLinearTickmarksImage(
  ...
  console.warn(
    "[DEPRECATED] OLD__drawLinearTickmarksImage() is deprecated! Use drawLinearTickmarksImage(ctx, options) instead"
  );
  drawLinearTickmarks(ctx, {
    width,
    height,
    gaugeType,
...
export function drawRadialTickmarksImage(
  ...
  console.warn(
    "[DEPRECATED] OLD__drawRadialTickmarksImage is deprecated! Use drawTickmarkLabels(ctx, options) instead for tickmark labels!"
  );
  ...
  if (!labelsOnly) {
    console.warn(
      "[DEPRECATED] OLD__drawRadialTickmarksImage is deprecated! Use drawTickmarks(ctx, options) instead for tickmarks!"
    );
