...
import { PointerTypeDef } from "../customization/type-descriptors"
...
function drawPointerImage(ctx: CanvasCtx, size: number, ptrType: PointerTypeDef, ptrColor: ColorDef, lblColor: RgbaColor) {
  ...
  if (!(CACHE_KEY in cache)) {
    ...
    switch (ptrType.type) {
      ...
      case "type10":
        ...
        ptrCtx.bezierCurveTo(size * 0.443925, size * 0.53271, size * 0.467289, size * 0.556074, size * 0.5, size * 0.556074)
        ptrCtx.bezierCurveTo(size * 0.53271, size * 0.556074, size * 0.556074, size * 0.53271, size * 0.556074, size * 0.5)
      ...
      case "type16":
        ...
        ptrCtx.fillStyle = createLinearGradient(ptrCtx, size * 0.5 - radius, size * 0.5 + radius, 0, size * 0.5 + radius, [
      ...
      default:
        ...
        ptrCtx.bezierCurveTo(size * 0.467289, size * 0.518691, size * 0.481308, size * 0.53271, size * 0.5, size * 0.53271)
        ptrCtx.bezierCurveTo(size * 0.518691, size * 0.53271, size * 0.53271, size * 0.518691, size * 0.53271, size * 0.5)
        ptrCtx.bezierCurveTo(size * 0.53271, size * 0.490654, size * 0.528037, size * 0.481308, size * 0.518691, size * 0.471962)
        ptrCtx.closePath()
        ptrCtx.fill()
        break
    }
