import { KnobStyleDef } from '../customization/type-descriptors';
import { TWO_PI } from "../utils/constants";

export function drawStandardKnob(ctx: CanvasRenderingContext2D, size: number, knobStyle: KnobStyleDef) {
...
export function drawMetalKnob(ctx: CanvasRenderingContext2D, size: number, knobStyle: KnobStyleDef) {
  let grad;
